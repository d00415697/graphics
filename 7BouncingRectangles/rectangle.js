class Rectangle{
    constructor(xlow, xhigh, ylow, yhigh){ // make the rectangles inside these World Coordinates
        ...
        this.airfriction = 0.99; //this is new code. represents friction
    ...
    update(DT){
        this.dy -= 0.25; //line 25 - 27 is new code. This is Gravity. Increase for speed/ Decrease for slower speed
